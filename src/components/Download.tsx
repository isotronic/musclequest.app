...
const Download: React.FC = () => {
  return (
    <section className="bg-tint text-background flex flex-col items-center px-6 py-16">
      ...
      <a
        ...
        className="flex items-center rounded-full bg-white px-6 py-3 text-lg font-semibold transition duration-200 hover:bg-gray-200"
      >
